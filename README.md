...
При измерении времени для наивной реализации с оптимизацией -O0, волноваться о том, что компилятор выкинет цикл не нужно, поэтому можно просто запустить без каких-либо доп переменных и померить: 
