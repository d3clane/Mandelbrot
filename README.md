...
Продолжаем рассчитывать, пока точка (x, y) не выйдет за грань выбранного нами круга. При расчете необходимо запоминать, за сколько итераций точка вышла из выделенной нами окружности. В зависимости от этого значения высчитывается формула для цвета точки (x0, y0). К сожалению, точка может никогда не выйти за грань круга, для этого сверху есть ограничение в 255 итераций - после этого цикл принудительно прерывается.
